...
## 外部ユーザーの指定方法まとめ
| 環境 | 個別のユーザー指定 | ドメイン指定(Azure AD ではそのドメインを持つテナント前提) | 認証されたユーザーは誰でも |
|:---:|:---:|:---:|:---:|
|Office 365 Apps for Business | 〇 | 〇 | × |
|AIP Client 右クリック | 〇 | △  (特殊な AllStaff-7184AB3F-CCD1-46F3-8233-3E09E9CF0E66@ドメイン名という指定方法であれば可) | × |
