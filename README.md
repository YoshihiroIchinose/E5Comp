...
| ページ | 内容 |
| --- | ---- |
|[Purview での日本語のマッチング処理について](https://github.com/YoshihiroIchinose/E5Comp/blob/main/matchinglogic.md)|Purview でカスタムの機密情報の種類でキーワード リストの文字列の一致を用いた場合のマッチングの仕組みについて、各種テストから判明した動作についてまとめました。|
